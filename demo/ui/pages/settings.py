...
from demo.ui.state.host_agent_service import UpdateApiKey
from demo.ui.state.state import AppState, SettingsState
            ...
            with me.box(
                ...
                me.select(
                    ...
                    options=[
                        ...
                        me.SelectOption(label='Video', value='video/*'),
                        me.SelectOption(
