...
class DeleteConversationRequest(JSONRPCRequest):
    ...
    params: str # conversation_id to delete


class DeleteConversationResponse(JSONRPCResponse):
    result: bool | None = None # True if successful, False otherwise
...
class UnregisterAgentRequest(JSONRPCRequest):
    ...
    params: str # This is the base url of the agent to unregister
